...
Expected private deploy order:
  ...
  14. Prove backup shipping, firewall, DNS, public route, observability, admission, failover, and DR gates.
...
Honest state:
  ...
  It is still not a full Proxmox installer until a clean-room Proxmox install is
